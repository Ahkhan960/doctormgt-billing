...
<div class="vertical-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="index" class="logo logo-light">
            <span class="logo-sm">
                <img src="{{ URL::asset('build/images/logo.png') }}" alt="logo-sm-light" height="44">
            </span>
            <span class="logo-lg">
                <img src="{{ URL::asset('build/images/logo.png') }}" alt="logo-light" height="42">
            </span>
        </a>
    </div>
        ...
        <button type="button" class="btn w-100 px-0 border-0" id="page-header-user-dropdown"
            ...
            <span class="d-flex align-items-center">
                <div class="flex-shrink-0">
                    @php
                        $user = auth()->user();
                        $profileSrc = $user && $user->profile_picture_path
                            ? asset('storage/'.$user->profile_picture_path)
                            : URL::asset('build/images/users/avatar-2.jpg');
                    @endphp
                    <img src="{{ $profileSrc }}" class="img-fluid header-profile-user rounded-circle" alt="">
                </div>
